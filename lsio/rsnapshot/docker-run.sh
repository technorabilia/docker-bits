...
docker run -d \
  ...
  -v ${BASEDIR:-/volume1/docker}/rsnapshot/.snapshots:/.snapshots `# Storage location for all snapshots. [OPTIONAL]` \
  -v ${BASEDIR:-/volume1/docker}/rsnapshot/data:/data `# Storage location for data to be backed up. [OPTIONAL]` \
