# [SickGear]({{ project_url }}) provides management of TV shows and/or Anime, it
# detects new episodes, links downloader apps, and more..  For more information
# on SickGear visit their website and check it out:
