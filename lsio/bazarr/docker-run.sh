...
docker run -d \
  ...
  -v ${BASEDIR:-/srv/lsio}/bazarr/config:/config `# Persistent config files` \
  -v ${BASEDIR:-/srv/lsio}/bazarr/movies:/movies `# Location of your movies [OPTIONAL]` \
  -v ${BASEDIR:-/srv/lsio}/bazarr/tv:/tv `# Location of your TV Shows [OPTIONAL]` \
