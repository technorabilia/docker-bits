...
docker run -d \
  ...
  -v ${BASEDIR:-/volume1/docker}/sickchill/downloads:/downloads `# this will store any downloaded data on the docker host [OPTIONAL]` \
  -v ${BASEDIR:-/volume1/docker}/sickchill/tv:/tv `# this will allow sickchill to view what you already have [OPTIONAL]` \
