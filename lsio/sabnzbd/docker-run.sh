...
docker run -d \
  ...
  -v ${BASEDIR:-/volume1/docker}/sabnzbd/incomplete-downloads:/incomplete-downloads `# Local path for incomplete-downloads. [OPTIONAL]` \
  -v ${BASEDIR:-/volume1/docker}/sabnzbd/downloads:/downloads `# Local path for finished downloads. [OPTIONAL]` \
